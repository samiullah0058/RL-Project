...
class Trainer:
    ...
    def __init__(
        ...
        policy_model = self.module.get_policy_model() \
            if hasattr(self.module, "get_policy_model") else self.module._model
        self.train_op = get_default_train_op(policy_model,
                                             learning_rate,
                                             gradient_clip,
                                             gradient_clip_norm)
